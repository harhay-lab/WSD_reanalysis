...
#alphass=t(t((1:p)/p))/20#(100*p)
#alphasn=-t(t((1:p)/p))/10#(90*p)

alphass=glm(da1$yind~as.matrix(xm1[,-1])-1,family=binomial)$coef 
alphasn=glm(da0$yind~as.matrix(xm0[,-1])-1,family=binomial)$coef 
